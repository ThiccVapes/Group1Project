...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { end_play: @play.end_play, playID: @play.playID, start_play: @play.start_play, time_played: @play.time_played, userID: @play.userID }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { end_play: @play.end_play, playID: @play.playID, start_play: @play.start_play, time_played: @play.time_played, userID: @play.userID }
    assert_redirected_to play_path(assigns(:play))
  end
